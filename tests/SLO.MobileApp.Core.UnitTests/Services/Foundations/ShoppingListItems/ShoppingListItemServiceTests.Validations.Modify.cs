...
public partial class ShoppingListItemServiceTests
{
    ...
    [Fact]
    public async Task ShouldThrowValidationExceptionOnModifyIfStorageCreatedByNotSameAsInputCreatedByAndLogItAsync()
    {
        // given
        DateTimeOffset currentDateTime = Randomizers.GetRandomDateTime();
        ...
        storageShoppingListItem.CreatedBy = notSameId;
    ...
    [Fact]
    public async Task ShouldThrowValidationExceptionOnModifyIfStorageCreatedAtNotSameAsInputCreatedAtAndLogItAsync()
    {
        // given
        DateTimeOffset currentDateTime = Randomizers.GetRandomDateTime();
        ...
        storageShoppingListItem.CreatedAt = notSameDateTime;
    ...
    [Fact]
    public async Task ShouldThrowValidationExceptionOnModifyIfStorageUpdatedAtSameAsInputUpdatedAtAndLogItAsync()
    {
        // given
        DateTimeOffset currentDateTime = Randomizers.GetRandomDateTime();
        ...
        invalidShoppingListItemException.AddData(
            key: nameof(ShoppingListItem.UpdatedAt),
            values: $"Date is same as {nameof(ShoppingListItem.UpdatedAt)}.");
